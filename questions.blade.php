...
@section('content')
	...
	<p>
		...
		{{ Form::select('course_name', array('1' => 'CSC 101', '2' => 'CSC 201', '3' => 'CSC 203', '4' => 'CSC 204', '5' => 'CSC 301', '6' => 'CSC 305', '7' => 'CSC 306', '8' => 'CSC 401', '9' => 'CSC 405', '10' => 'CSC 455')) }}
	</p>
	<p>
	...
	<p>
		{{ Form::label('question02','Does the instructor provide materials related to the course?') }}<br />
